    ...
    card(
      ...
      layout_sidebar(
        ...
        layout_columns(
          ...
          leafletOutput('map'),
          h3(textOutput("blk_grp_name_map", inline = TRUE), style="color: rgb(51, 51, 51); font-size: 18px; font-family: Roboto Condensed; font-weight: bold; fill: rgb(51, 51, 51);")
...
server <- function(input, output, session){
  ...
  observeEvent(list(click_tract(), listen_closely()), {
    ...
    output$blk_grp_detail <- renderUI({
      HTML(paste0('<span style="color: rgb(51, 51, 51); font-size: 18px; font-family: Roboto Condensed; font-weight: bold; fill: rgb(51, 51, 51);">Selected Block Group: ', d$names, '</span><br/>',
                  '<span style="color: rgb(51, 51, 51); font-size: 16px; font-family: Roboto Condensed; font-weight: bold; fill: rgb(51, 51, 51);">', d$locality, ', Virginia; Block group: ', d$tract, '<br/>Population: ', as.character(d$totpop_est), '</span>')
      )
    })
    
    output$blk_grp_name <- renderUI({
      HTML(paste0('<span style="color: rgb(51, 51, 51); font-size: 18px; font-family: Roboto Condensed; font-weight: bold; fill: rgb(51, 51, 51);">Selected Block Group: ', d$names, '</span><br/>',
                  '<span style="color: rgb(51, 51, 51); font-size: 16px; font-family: Roboto Condensed; fill: rgb(51, 51, 51);">', d$locality, ', Virginia<br/>Block group: ', d$tract, '<br/>Population: ', as.character(d$totpop_est), '</span>',
                  '<br/><br/>',
    ...
    output$blk_grp_name_map <- renderText({
      paste0("Selected Block Group: ", d$names)
    })
  }
